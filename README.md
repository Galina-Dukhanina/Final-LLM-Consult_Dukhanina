...
## Скриншот работы Telegram-бота

На скриншоте показан полный пользовательский сценарий: отказ без токена, отказ с невалидным токеном, сохранение валидного токена, принятие запроса в обработку и финальный ответ от LLM.
